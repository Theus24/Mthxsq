...
export const listProyek = [
  ...
  },
  {
    ...
    image: reparo,
    title: "AnonIG",
    subtitle: "Veja storys e highlights no Instagram de forma anonônima 👀.",
    fullDescription:"Veja storys e highlights no Instagram de forma anonônima 👀.",
    borderColor: "#3B82F6",
    gradient: "linear-gradient(145deg, #3B82F6, #000)",
    url: "https://github.com/rissss21",
    dad: "400", 
  ...
  },
  {
    ...
    subtitle: "Veja suas estatisticas do Spotify de forma simples e rápida.",
    fullDescription:"Veja suas estatisticas do Spotify de forma simples e rápida.",
    borderColor: "#3B82F6",
    gradient: "linear-gradient(145deg, #3B82F6, #000)",
    url: "https://github.com/rissss21",
    dad: "400",
